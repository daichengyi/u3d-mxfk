...
namespace Assets.Scripts.common.ScrollList
{
    ...
    public sealed class ScrollList : ScrollRect
    {
        ...
        public ScrollListElement IndexGetElement(int index)
        {
            return _elements.ContainsKey(_datas[index]) ? _elements[_datas[index]] : null;
        }
        /// <summary>
        /// 当前数据数量
        /// </summary>
        ...
        public void AddData(ScrollListData data)
        {
            ...
            {
                Debug.LogWarning("滚动数据列表：添加数据失败，列表中已存在该数据 " + data.ToString());
                return;
            }
        ...
        public void RemoveData(ScrollListData data)
        {
            ...
            {
                Debug.LogWarning("滚动数据列表：移除数据失败，列表中不存在该数据 " + data.ToString());
            }
        }
        /// <summary>
        /// 清除所有的数据
